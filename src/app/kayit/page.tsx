    ...
    <div className="min-h-screen bg-neutral-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-neutral">
          ...
          <Link href="/giris" className="font-medium text-primary hover:text-primary-dark">
            Giriş yapın
          </Link>
        </p>
      </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 block text-sm text-neutral">
                <span>
                  <Link href="/kullanim-kosullari" className="text-primary hover:text-primary-dark">
                    Kullanım Koşulları
                  </Link>
                  {' '}ve{' '}
                  <Link href="/gizlilik-politikasi" className="text-primary hover:text-primary-dark">
                    Gizlilik Politikası
                  </Link>
                  'nı kabul ediyorum
                </span>
